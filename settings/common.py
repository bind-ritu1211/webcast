...
APPS_DIR = ROOT_DIR.path("webcast")
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "webcast.base.api.pagination.LimitOffsetPagination",
    "PAGE_SIZE": 30,
    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "webcast.base.renderers.WebcastApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "webcast.users.auth.backends.UserTokenAuthentication",
        # Mainly used for api debug.
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_SCHEMA_CLASS": "rest_framework.schemas.coreapi.AutoSchema",
    "EXCEPTION_HANDLER": "webcast.base.exceptions.exception_handler",
}
...
SITE_NAME = env("SITE_NAME", default="webcast")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="webcast")
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="webcast <support@webcast.com>"
)
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[webcast] ")
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///webcast")}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "webcast.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "webcast.base.views.csrf_failure"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "webcast": {"handlers": ["console"], "level": "INFO", "propagate": False},
